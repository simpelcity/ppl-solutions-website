    ...
    <footer className="bg-dark text-light py-4">
      <Container className="px-3 d-flex flex-column align-items-center" fluid>
        <Row className="w-100 d-flex row-gap-4">
          <Col xs={12} md={12} xl={6} className="d-flex flex-column align-items-center text-center align-items-xl-start text-xl-start">
              ...
              <Col xs={12} md={3} lg={4}>
                ...
                <ListGroup className="fs-5">
                  {footerLinks.map((item) => (
                    <FooterLink key={item.href} link={item.href}>{item.title}</FooterLink>
                  ))}
                </ListGroup>
              </Col>
                ...
                <Tabs defaultActiveKey="links" className="nav-fill mb-3 border-primary">
                  <Tab eventKey="links" title="Other links" className="border-0">
                    <ListGroup>
                      ...
                      <FooterLink href="https://truckersmp.com/vtc/74455" target="_blank">VTC</FooterLink>
                    </ListGroup>
                  </Tab>
                  <Tab eventKey="message" title="Message" className="border-0">
                    <p className="text-center text-md-start">
                      Hello there traveler, My name is <strong>Simpelcity</strong>. Welcome on the website of the Virtual
                      Trucking Company: <strong>PPL Solutions</strong>, we stand for driver comfort and the fun in doing great
                      things together.
                    </p>
                  </Tab>
                </Tabs>
        ...
        <p className="border-top border-light pt-3 mt-4 mb-0 fs-5 text-center w-100">
          <FaRegCopyright className="fs-6" /> Copyright {currentYear} <strong>PPL Solutions.</strong> All rights Reserved | Developed by{" "}
          <a className="text-decoration-none author fw-bold" href="https://simpelcity.github.io">Simpelcity</a>
        </p>
      </Container>
    </footer>
  )
