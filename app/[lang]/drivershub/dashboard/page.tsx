...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    title: `${dict.drivershub.dashboard.dashboard.meta.title} | PPL Solutions VTC`,
    description: dict.drivershub.dashboard.dashboard.meta.description,
    openGraph: {
      title: `${dict.drivershub.dashboard.dashboard.meta.title} | PPL Solutions VTC`,
      description: dict.drivershub.dashboard.dashboard.meta.description,
      url: canonical,
...
export default async function DashboardPage({ params }: PageProps) {
  ...
  return (
    <>
      <main className="fs-5 drivershub">
        <section className="h-100 w-100 d-flex justify-content-center bg-surface-darker text-theme">
