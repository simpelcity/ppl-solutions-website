...
$connectionPath = realpath(__DIR__ . "/../modules/redirects/connection.php");

if ($connectionPath) {
	include $connectionPath;
} else {
	die("Error: connection wasn't found.");
}
		...
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container-fluid w-100 px-0">
				...
				<a class="navbar-brand d-flex align-items-center" href="/">
					<img class="rounded-circle me-2 ms-3" src="/assets/images/ppls_logo.png" alt="PPL Solutions Logo" width="50" height="50">
